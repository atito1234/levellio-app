...
export const NAMESPACES = ['common', 'tabs', 'feed', 'settings', 'paywall', 'profile', 'notifications', 'discover', 'stories', 'messaging', 'ai', 'onboarding', 'auth', 'dashboard', 'capacities', 'hero', 'danger', 'projects', 'featured', 'addActivity'] as const;
