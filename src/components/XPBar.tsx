    ...
    <View style={styles.container}>
      <View style={styles.row}>
        <View style={styles.levelChip}>
          <Text style={styles.levelChipText}>LVL {character.level}</Text>
        </View>
        <Text style={styles.tier}>{TIER_LABEL[character.tier]}</Text>
      </View>
      <ProgressBar progress={progress} label="XP progress to next level" />
      <Text style={styles.xpText} accessibilityLabel={`${character.xp} of ${needed} XP`}>
