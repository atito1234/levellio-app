...
> Generated from source by `npm run generate:listing` — do not edit by hand.

## Title (≤30)

Levellio: Habit Tracker RPG

## Short description (≤80)

Turn habits into quests — earn XP, build streaks, and level up your hero.

## Full description (≤4000)

Levellio turns your real life into a solo RPG. Every habit, routine, and goal becomes a quest — complete it, earn XP, and level up a hero you make your own.
